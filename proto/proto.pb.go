...
var file_proto__proto_rawDesc = []byte{
	,
	...
	,
...
var file_proto__proto_goTypes = []interface{}{
	(*GetHealthRequest)(nil),     // 0: GetHealthRequest
	(*GetHealthResponse)(nil),    // 1: GetHealthResponse
...
var file_proto__proto_depIdxs = []int32{
	0, // 0: ClockService.GetHealth:input_type -> GetHealthRequest
	2, // 1: ClockService.GetTimestamp:input_type -> GetTimestampRequest
	1, // 2: ClockService.GetHealth:output_type -> GetHealthResponse
	3, // 3: ClockService.GetTimestamp:output_type -> GetTimestampResponse
...
func (c *clockServiceClient) GetHealth(ctx context.Context, in *GetHealthRequest, opts ...grpc.CallOption) (*GetHealthResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ClockService/GetHealth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clockServiceClient) GetTimestamp(ctx context.Context, in *GetTimestampRequest, opts ...grpc.CallOption) (*GetTimestampResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ClockService/GetTimestamp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ClockService_GetHealth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ClockService/GetHealth",
	}
...
func _ClockService_GetTimestamp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ClockService/GetTimestamp",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
